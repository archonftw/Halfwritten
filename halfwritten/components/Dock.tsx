...
function DockItem({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`relative inline-flex items-center text-white justify-center rounded-full bg-[#060010] border-neutral-700 border-2 shadow-md ${className}`}
      tabIndex={0}
      role="button"
      aria-haspopup="true"
    >
...
export default function Dock({
  ...
  return (
  <motion.div
    className="fixed bottom-2 left-1/2 z-50 -translate-x-1/2 flex items-end"
    onMouseMove={({ pageX }) => {
      isHovered.set(1);
      mouseX.set(pageX);
    }}
